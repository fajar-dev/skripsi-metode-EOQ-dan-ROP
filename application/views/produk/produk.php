  				...
  				<div class="x_panel">
  					<div class="x_title">
  						...
  						<ul class="nav navbar-right panel_toolbox">
  							<li><a href="#myModaltambah" class="btn btn-default" id="custId" data-toggle="modal" ><i class="fa fa-plus-circle"></i> Tambah Produk</a></li>
  						</ul>
  						<div class="clearfix"></div>
  					</div>
  					<div class="x_content">
...
<?php foreach ($data->result_array() as $i) :  ?>
 ...
 <div class="modal fade" id="ModalEdit<?php echo $i['produk_kode'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<?php foreach ($data->result_array() as $i) :
 ?>
 <div class="modal fade" id="ModalHapus<?php echo $i['produk_kode'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
